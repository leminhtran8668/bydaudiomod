...
public class DoorSoundService extends Service {
    ...
    private void createNotificationChannel() {
        NotificationChannel channel = new NotificationChannel(
                CHANNEL_ID, "Dịch vụ Âm Thanh Cửa Xe", NotificationManager.IMPORTANCE_LOW);
    ...
    private Notification buildNotification() {
        ...
        return new Notification.Builder(this, CHANNEL_ID)
                .setContentTitle("Âm Thanh Cửa Xe")
                .setContentText("Đang theo dõi sự kiện cửa xe...")
    ...
    void handleDoorOpen(int area) {
        ...
        setLastEvent(getDoorName(area) + " đã mở");
    ...
    void handleDoorClose(int area) {
        ...
        setLastEvent(getDoorName(area) + " đã đóng");
    ...
    private String getDoorName(int area) {
        switch (area) {
            case 1: return "Cửa trước trái";
            case 2: return "Cửa trước phải";
            case 3: return "Cửa sau trái";
            case 4: return "Cửa sau phải";
            case 5: return "Nắp capo";
            case 6: return "Cốp sau";
            default: return "Cửa " + area;
        }
    }
